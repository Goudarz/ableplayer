...
(function ($) {
  ...
  window.AblePlayer = function (media) {
    ...
    // start-time
    if (
      $(media).data("start-time") !== undefined &&
      $.isNumeric($(media).data("start-time"))
    ) {
    ...
    // debug
    if (
      $(media).data("debug") !== undefined &&
      $(media).data("debug") !== false
    ) {
      this.debug = true;
    } else {
      this.debug = false;
    ...
    if (
      $(media).data("use-descriptions-button") !== undefined &&
      $(media).data("use-descriptions-button") === false
    ) {
    ...
    if (
      ...
      if (/^[0-6]*$/.test(headingLevel)) {
        // must be a valid HTML heading level 1-6; or 0
    ...
    if (
      $(media).data("transcript-div") !== undefined &&
    ...
    if (
      $(media).data("include-transcript") !== undefined &&
      $(media).data("include-transcript") === false
    ) {
    ...
    if ($(media).data("transcript-src") !== undefined) {
      ...
      $(media).find('track[kind="captions"], track[kind="subtitles"]').length >
      0
    ) {
    ...
    if ($(media).data("captions-position") === "overlay") {
      ...
      // the default, even if not specified
      this.defaultCaptionsPosition = "below";
    }

    // Chapters
    if (
      $(media).data("chapters-div") !== undefined &&
      $(media).data("chapters-div") !== ""
    ) {
    ...
    if (
      $(media).data("chapters-default") !== undefined &&
      $(media).data("chapters-default") !== ""
    ) {
    ...
    if (
      $(media).data("seekbar-scope") === "chapter" ||
      $(media).data("seekbar-scope") === "chapters"
    ) {
    ...
    // YouTube
    if (
      $(media).data("youtube-id") !== undefined &&
      $(media).data("youtube-id") !== ""
    ) {
      this.youTubeId = $(media).data("youtube-id");
    }

    if (
      $(media).data("youtube-desc-id") !== undefined &&
      $(media).data("youtube-desc-id") !== ""
    ) {
      this.youTubeDescId = $(media).data("youtube-desc-id");
    }

    if (
      $(media).data("youtube-nocookie") !== undefined &&
      $(media).data("youtube-nocookie")
    ) {
    ...
    // Vimeo
    if (
      $(media).data("vimeo-id") !== undefined &&
      $(media).data("vimeo-id") !== ""
    ) {
      this.vimeoId = $(media).data("vimeo-id");
    }
    if (
      $(media).data("vimeo-desc-id") !== undefined &&
      $(media).data("vimeo-desc-id") !== ""
    ) {
    ...
    if (
      $(media).data("allow-fullscreen") !== undefined &&
      $(media).data("allow-fullscreen") === false
    ) {
    ...
    if (
      $(media).data("show-now-playing") !== undefined &&
      $(media).data("show-now-playing") === false
    ) {
    ...
    if (
      $(media).data("test-fallback") !== undefined &&
      $(media).data("test-fallback") !== false
    ) {
    ...
    if (
      $(media).data("force-lang") !== undefined &&
      $(media).data("force-lang") !== false
    ) {
      this.forceLang = true;
    } else {
    ...
    // Metadata Tracks
    if (
      $(media).data("meta-type") !== undefined &&
      $(media).data("meta-type") !== ""
    ) {
      this.metaType = $(media).data("meta-type");
    }

    if (
      $(media).data("meta-div") !== undefined &&
      $(media).data("meta-div") !== ""
    ) {
    ...
    // Search
    if (
      $(media).data("search") !== undefined &&
      $(media).data("search") !== ""
    ) {
      // conducting a search currently requires an external div in which to write the results
      if (
        $(media).data("search-div") !== undefined &&
        $(media).data("search-div") !== ""
      ) {
      ...
      // Search Language
      if (
        $(media).data("search-lang") !== undefined &&
        $(media).data("search-lang") !== ""
      ) {
    ...
    this.tt = {};
    var thisObj = this;
    $.when(this.getTranslationText()).then(function () {
...
(function ($) {
  ...
  AblePlayer.prototype.getSvgData = function (button) {
    ...
    switch (button) {
      case "play":
        svg[0] = "0 0 16 20";
        svg[1] =
          "M0 18.393v-16.429q0-0.29 0.184-0.402t0.441 0.033l14.821 8.237q0.257 0.145 0.257 0.346t-0.257 0.346l-14.821 8.237q-0.257 0.145-0.441 0.033t-0.184-0.402z";
        break;

      case "pause":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M0 18.036v-15.714q0-0.29 0.212-0.502t0.502-0.212h5.714q0.29 0 0.502 0.212t0.212 0.502v15.714q0 0.29-0.212 0.502t-0.502 0.212h-5.714q-0.29 0-0.502-0.212t-0.212-0.502zM10 18.036v-15.714q0-0.29 0.212-0.502t0.502-0.212h5.714q0.29 0 0.502 0.212t0.212 0.502v15.714q0 0.29-0.212 0.502t-0.502 0.212h-5.714q-0.29 0-0.502-0.212t-0.212-0.502z";
        break;

      case "stop":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M0 18.036v-15.714q0-0.29 0.212-0.502t0.502-0.212h15.714q0.29 0 0.502 0.212t0.212 0.502v15.714q0 0.29-0.212 0.502t-0.502 0.212h-15.714q-0.29 0-0.502-0.212t-0.212-0.502z";
        break;

      case "restart":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M18 8h-6l2.243-2.243c-1.133-1.133-2.64-1.757-4.243-1.757s-3.109 0.624-4.243 1.757c-1.133 1.133-1.757 2.64-1.757 4.243s0.624 3.109 1.757 4.243c1.133 1.133 2.64 1.757 4.243 1.757s3.109-0.624 4.243-1.757c0.095-0.095 0.185-0.192 0.273-0.292l1.505 1.317c-1.466 1.674-3.62 2.732-6.020 2.732-4.418 0-8-3.582-8-8s3.582-8 8-8c2.209 0 4.209 0.896 5.656 2.344l2.344-2.344v6z";
        break;

      case "rewind":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M11.25 3.125v6.25l6.25-6.25v13.75l-6.25-6.25v6.25l-6.875-6.875z";
        break;

      case "forward":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M10 16.875v-6.25l-6.25 6.25v-13.75l6.25 6.25v-6.25l6.875 6.875z";
        break;
      ...
      case "volume-mute":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M7.839 1.536c0.501-0.501 0.911-0.331 0.911 0.378v16.172c0 0.709-0.41 0.879-0.911 0.378l-4.714-4.713h-3.125v-7.5h3.125l4.714-4.714zM18.75 12.093v1.657h-1.657l-2.093-2.093-2.093 2.093h-1.657v-1.657l2.093-2.093-2.093-2.093v-1.657h1.657l2.093 2.093 2.093-2.093h1.657v1.657l-2.093 2.093z";
        break;

      case "volume-soft":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M10.723 14.473c-0.24 0-0.48-0.092-0.663-0.275-0.366-0.366-0.366-0.96 0-1.326 1.584-1.584 1.584-4.161 0-5.745-0.366-0.366-0.366-0.96 0-1.326s0.96-0.366 1.326 0c2.315 2.315 2.315 6.082 0 8.397-0.183 0.183-0.423 0.275-0.663 0.275zM7.839 1.536c0.501-0.501 0.911-0.331 0.911 0.378v16.172c0 0.709-0.41 0.879-0.911 0.378l-4.714-4.713h-3.125v-7.5h3.125l4.714-4.714z";
        break;

      case "volume-medium":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M14.053 16.241c-0.24 0-0.48-0.092-0.663-0.275-0.366-0.366-0.366-0.96 0-1.326 2.559-2.559 2.559-6.722 0-9.281-0.366-0.366-0.366-0.96 0-1.326s0.96-0.366 1.326 0c1.594 1.594 2.471 3.712 2.471 5.966s-0.878 4.373-2.471 5.966c-0.183 0.183-0.423 0.275-0.663 0.275zM10.723 14.473c-0.24 0-0.48-0.092-0.663-0.275-0.366-0.366-0.366-0.96 0-1.326 1.584-1.584 1.584-4.161 0-5.745-0.366-0.366-0.366-0.96 0-1.326s0.96-0.366 1.326 0c2.315 2.315 2.315 6.082 0 8.397-0.183 0.183-0.423 0.275-0.663 0.275zM7.839 1.536c0.501-0.501 0.911-0.331 0.911 0.378v16.172c0 0.709-0.41 0.879-0.911 0.378l-4.714-4.713h-3.125v-7.5h3.125l4.714-4.714z";
        break;

      case "volume-loud":
        svg[0] = "0 0 21 20";
        svg[1] =
          "M17.384 18.009c-0.24 0-0.48-0.092-0.663-0.275-0.366-0.366-0.366-0.96 0-1.326 1.712-1.712 2.654-3.988 2.654-6.408s-0.943-4.696-2.654-6.408c-0.366-0.366-0.366-0.96 0-1.326s0.96-0.366 1.326 0c2.066 2.066 3.204 4.813 3.204 7.734s-1.138 5.668-3.204 7.734c-0.183 0.183-0.423 0.275-0.663 0.275zM14.053 16.241c-0.24 0-0.48-0.092-0.663-0.275-0.366-0.366-0.366-0.96 0-1.326 2.559-2.559 2.559-6.722 0-9.281-0.366-0.366-0.366-0.96 0-1.326s0.96-0.366 1.326 0c1.594 1.594 2.471 3.712 2.471 5.966s-0.878 4.373-2.471 5.966c-0.183 0.183-0.423 0.275-0.663 0.275zM10.723 14.473c-0.24 0-0.48-0.092-0.663-0.275-0.366-0.366-0.366-0.96 0-1.326 1.584-1.584 1.584-4.161 0-5.745-0.366-0.366-0.366-0.96 0-1.326s0.96-0.366 1.326 0c2.315 2.315 2.315 6.082 0 8.397-0.183 0.183-0.423 0.275-0.663 0.275zM7.839 1.536c0.501-0.501 0.911-0.331 0.911 0.378v16.172c0 0.709-0.41 0.879-0.911 0.378l-4.714-4.713h-3.125v-7.5h3.125l4.714-4.714z";
        break;

      case "chapters":
        svg[0] = "0 0 20 20";
        svg[1] =
          "M5 2.5v17.5l6.25-6.25 6.25 6.25v-17.5zM15 0h-12.5v17.5l1.25-1.25v-15h11.25z";
        break;
  ...
  AblePlayer.prototype.getMatchingHeight = function (width) {
    ...
    $.each(widths, function (index) {
      if (
        closestWidth == null ||
        Math.abs(this - width) < Math.abs(closestWidth - width)
      ) {
        closestWidth = this;
        closestIndex = index;
      }
  ...
  AblePlayer.prototype.setIconType = function () {
    ...
    if (
      ...
      if (window.getComputedStyle) {
        ...
        controllerFont = window
          .getComputedStyle($testButton.get(0), null)
    ...
    if (captions.length > 0) {
      ...
      if (typeof this.captionLang !== "undefined") {
        ...
        if (this.$transcriptLanguageSelect) {
          this.$transcriptLanguageSelect
            .find("option[lang=" + this.captionLang + "]")
            .prop("selected", true);
        }
      ...
      if (this.player === "vimeo") {
        if (this.usingVimeoCaptions && this.prefCaptions == 1) {
          ...
          this.vimeoPlayer
            .enableTextTrack(this.captionLang)
            .then(function (track) {
  ...
  AblePlayer.prototype.getPlayer = function () {
    ...
    if (this.youTubeId) {
      ...
      this.testFallback ||
      ((this.isUserAgent("msie 7") ||
        this.isUserAgent("msie 8") ||
        this.isUserAgent("msie 9")) &&
        this.mediaType === "video") ||
...
*/
  ...
  AblePlayer.prototype.injectPrefsForm = function (form) {
    ...
    if (form == "captions") {
      ...
      if (this.hasOpenDesc && this.hasClosedDesc) {
        ...
        currentDescState +=
          "<strong>" + this.tt.prefDescFormatOption1b + "</strong>";
        currentDescState +=
          " <em>" +
          this.tt.and +
          "</em> <strong>" +
          this.tt.prefDescFormatOption2b +
          "</strong>.";
        ...
        currentDescState = this.tt.prefIntroDescription2;
        currentDescState +=
          " <strong>" + this.tt.prefDescFormatOption2b + "</strong>.";
      } else {
    ...
    if (form === "keyboard") {
      ...
      $legend = $(
        "<legend>" + this.tt.prefHeadingTextDescription + "</legend>"
      );
      $fieldset.append($legend);
    }
    for (i = 0; i < available.length; i++) {
      ...
      if (available[i]["group"] == form && available[i]["label"]) {
        ...
        if (form === "captions") {
          $thisLabel = $(
            '<label for="' + thisId + '"> ' + available[i]["label"] + "</label>"
          );
          $thisField = $("<select>", {
            name: thisPref,
            id: thisId,
          ...
          for (j = 0; j < options.length; j++) {
            if (thisPref === "prefCaptionsPosition") {
              ...
              thisPref === "prefCaptionsFont" ||
              thisPref === "prefCaptionsColor" ||
              thisPref === "prefCaptionsBGColor"
            ) {
          ...
          // all other fields are checkboxes
          $thisLabel = $(
            '<label for="' + thisId + '"> ' + available[i]["label"] + "</label>"
          );
          $thisField = $("<input>", {
      ...
      for (i = 0; i < this.controls.length; i++) {
        if (this.controls[i] === "play") {
          ...
          keys.push(
            "p</span> <em>" +
              this.tt.or +
              '</em> <span class="able-help-modifiers"> ' +
              this.tt.spacebar
          );
          ...
          keys.push(
            "v</span> <em>" + this.tt.or + '</em> <span class="able-modkey">1-9'
          );
          // mute toggle
    ...
    $prefsDiv.append("<hr>");
    saveButton = $(
      '<button class="modal-button">' + this.tt.save + "</button>"
    );
    cancelButton = $(
      '<button class="modal-button">' + this.tt.cancel + "</button>"
    );
  ...
  AblePlayer.prototype.savePrefsFromForm = function () {
    ...
    for (var i = 0; i < available.length; i++) {
      ...
      if (available[i]["label"]) {
        ...
        if (prefName == "prefDescFormat") {
          ...
          if (this.prefDescFormat !== cookie.preferences["prefDescFormat"]) {
            // user's preference has changed
            cookie.preferences["prefDescFormat"] = this.prefDescFormat;
            numChanges++;
          }
        } else if (
          prefName.indexOf("Captions") !== -1 &&
          prefName !== "prefCaptions"
        ) {
    ...
    if (
      this.player === "youtube" &&
      typeof this.usingYouTubeCaptions !== "undefined" &&
      this.usingYouTubeCaptions &&
      capSizeChanged
    ) {
      // update font size of YouTube captions
      this.youTubePlayer.setOption(
        this.ytCaptionModule,
        "fontSize",
        this.translatePrefs("size", capSizeValue, "youtube")
      );
    }
    if (AblePlayerInstances.length > 1) {
      ...
      for (var i = 0; i < AblePlayerInstances.length; i++) {
        ...
        if (numCapChanges > 0) {
          AblePlayerInstances[i].stylizeCaptions(
            AblePlayerInstances[i].$captionsDiv
          );
          // also apply same changes to descriptions, if present
          if (typeof AblePlayerInstances[i].$descDiv !== "undefined") {
            AblePlayerInstances[i].stylizeCaptions(
              AblePlayerInstances[i].$descDiv
            );
          }
        }
      }
...
(function ($) {
  ...
  function parseFileBody(state) {
    actList(state, [eatOptionalBOM, eatSignature]);
    var c = state.text[0];
    if (c === " " || c === "\t" || c === "\n") {
      actList(state, [
  ...
  function parseCuesAndComments(state) {
    while (true) {
      ...
      if (
        nextLine.indexOf("NOTE") === 0 &&
        (nextLine.length === 4 || nextLine[4] === " " || nextLine[4] === "\t")
      ) {
  ...
  function getCuePayload(state) {
    ...
    while (state.text.length > 0) {
      ...
      if (token.type === "string") {
        ...
        if (
          token.tagName === current.type &&
          $.inArray(token.tagName, ["c", "i", "b", "u", "ruby", "rt", "v"]) !==
            -1
        ) {
    ...
    while (true) {
      ...
      if (tokenState === "data") {
        ...
        if (c === "&") {
          ...
          // Handle unescaped & chars as strings
          result.push(buffer);
          token.type = "string";
          token.value = result.join("");
          return token;
  ...
  function getTiming(state) {
    ...
    var results = /((\d\d):)?((\d\d):)(\d\d).(\d\d\d)|(\d+).(\d\d\d)/.exec(
      timestamp
    );
...
(function ($) {
  AblePlayer.prototype.injectPlayerCode = function () {
    ...
    this.$mediaContainer = this.$media
      .wrap('<div class="able-media-container"></div>')
      .parent();
    this.$ableDiv = this.$mediaContainer
      .wrap('<div class="able"></div>')
      .parent();
    this.$ableWrapper = this.$ableDiv
      .wrap('<div class="able-wrapper"></div>')
      .parent();
    ...
    if (this.mediaType === "video") {
      ...
      if (
        this.iconType != "image" &&
        (this.player !== "youtube" || this.hasPoster)
      ) {
      ...
      this.$vidcapContainer = this.$mediaContainer
        .wrap(vidcapContainer)
        .parent();
    }
  ...
  AblePlayer.prototype.injectPlayerControlArea = function () {
    ...
    this.$timer
      .append(this.$elapsedTimeContainer)
      .append(this.$durationContainer);
  ...
  AblePlayer.prototype.getOptimumPosition = function (
    targetWindow,
    targetWidth
  ) {
    ...
    if (
      targetWidth <
      windowWidth - (ableLeft + ableWidth + gap + otherWindowWidth)
    ) {
  ...
  AblePlayer.prototype.createPopup = function (which, tracks) {
    ...
    if (which === "prefs") {
      ...
      for (i = 0; i < tracks.length; i++) {
        ...
        if (which == "captions") {
          ...
          $menuItem.text(
            this.flattenCueForCaption(track) +
              " - " +
              this.formatSecondsAsColonTime(track.start)
          );
      ...
      for (i = 0; i < windowOptions.length; i++) {
        ...
        $menuItem.on("click mousedown", function (e) {
          ...
          if (!thisObj.windowMenuClickRegistered && !thisObj.finishingDrag) {
            ...
            thisObj.handleMenuChoice(
              which.substr(0, which.indexOf("-")),
    ...
    if (which === "captions" && !hasDefault) {
      ...
      if ($menu.find('li:contains("' + this.defaultChapter + '")')) {
        $menu
          .find('li:contains("' + this.defaultChapter + '")')
          .attr("aria-checked", "true")
          .addClass("able-focus");
      } else {
        $menu
    ...
    if (popups.length > 0) {
      ...
      for (var i = 0; i < popups.length; i++) {
        ...
        if (popup == "prefs") {
          ...
          if (
            typeof this.captionsPopup === "undefined" ||
            !this.captionsPopup
          ) {
          ...
          if (
            typeof this.chaptersPopup === "undefined" ||
            !this.chaptersPopup
          ) {
  ...
  AblePlayer.prototype.provideFallback = function () {
    ...
    if (fallback.length) {
      ...
      fallbackText =
        this.tt.fallbackError1 + " " + this.tt[this.mediaType] + ". ";
  ...
  AblePlayer.prototype.calculateControlLayout = function () {
    ...
    if (this.mediaType === "video") {
      ...
      if (
        (this.hasOpenDesc || this.hasClosedDesc) &&
        this.useDescriptionsButton
      ) {
        numA11yButtons++;
        if (this.skin === "legacy") {
  ...
  AblePlayer.prototype.addControls = function () {
    ...
    if (this.skin == "2020") {
      ...
      this.seekBar = new AccessibleSlider(
        this.mediaType,
        $sliderDiv,
        "horizontal",
        baseSliderWidth,
    ...
    for (i = 0; i < numSections; i++) {
      ...
      if (i % 2 === 0) {
        // even keys on the left
        $controllerSpan = $("<div>", {
          class: "able-left-controls",
        });
      } else {
        // odd keys on the right
        $controllerSpan = $("<div>", {
      ...
      for (j = 0; j < controls.length; j++) {
        ...
        if (control === "seek") {
          ...
          if (this.iconType === "font") {
            ...
            $pipeImg = $("<img>", {
              src:
                this.rootPath + "button-icons/" + this.iconColor + "/pipe.png",
              alt: "",
              role: "presentation",
            });
            $pipe.append($pipeImg);
          ...
          $newButton.on("mouseenter focus", function (e) {
            ...
            var tooltipWidth = AblePlayer.localGetElementById(
              $newButton[0],
              tooltipId
            )
              .text(buttonText)
            ...
            var tooltip = AblePlayer.localGetElementById(
              $newButton[0],
              tooltipId
            )
              .text(buttonText)
            ...
            $(this).on("mouseleave blur", function () {
              AblePlayer.localGetElementById($newButton[0], tooltipId)
                .text("")
                .hide();
            });
          });
          ...
          if (control === "captions") {
            ...
            if (!this.prefDesc || this.prefDesc !== 1) {
              ...
              $newButton
                .addClass("buttonOff")
                .attr("title", this.tt.turnOnDescriptions);
            }
          }
          ...
          if (control === "play") {
            ...
            if (!this.$transcriptDiv.is(":visible")) {
              this.$transcriptButton
                .addClass("buttonOff")
                .attr("title", this.tt.showTranscript);
            }
          } else if (control === "fullscreen") {
...
*/
  ...
  AblePlayer.prototype.cuePlaylistItem = function (sourceIndex) {
    ...
    if (this.initializing) {
      // this is the first track - user hasn't pressed play yet
      // do nothing.
    } else {
      if (this.playerCreated) {
        // remove the old
    ...
    if (this.hasAttr($newItem, "data-youtube-desc-id")) {
      this.$media.attr(
        ...
        $newItem.attr("data-youtube-desc-id")
      );
    }
    if (this.youTubeId) {
    ...
    if (this.showNowPlaying === true) {
      if (typeof this.$nowPlayingDiv !== "undefined") {
        ...
        nowPlayingSpan.html(
          "<span>" + this.tt.selectedTrack + ":</span>" + itemTitle
        );
...
(function ($) {
  ...
  AblePlayer.prototype.setupCaptions = function (
    track,
    trackLang,
    trackLabel,
    cues
    ...
    if (this.captions.length === 0) {
      ...
      // there are already tracks in the array
      inserted = false;
...
*/
  ...
  AblePlayer.prototype.setupAltCaptions = function () {
    ...
    if (this.captions.length === 0) {
      ...
      // there are <track> captions, so no need for alt source captions
      deferred.resolve();
    }
    return promise;
  };
...
(function ($) {
  ...
  AblePlayer.prototype.finalizeYoutubeInit = function () {
    ...
    videoDimensions = this.getYouTubeDimensions(
  ...
  AblePlayer.prototype.resizeYouTubePlayer = function (
    youTubeId,
    youTubeContainerId
  ) {
  ...
  AblePlayer.prototype.setupYouTubeCaptions = function () {
    ...
    if (typeof youTubeDataAPIKey !== "undefined") {
      ...
      $.doWhen({
        ...
        .fail(function () {
          console.log(
            "Unable to initialize Google API. YouTube captions are currently unavailable."
          );
        });
    } else {
      deferred.resolve();
          ...
          gapi.client.load("youtube", "v3").then(function () {
            ...
            request.then(
              function (json) {
                if (json.result.items.length) {
                  ...
                  for (i = 0; i < json.result.items.length; i++) {
                    ...
                    var srcUrl = thisObj.getYouTubeTimedTextUrl(
                      youTubeId,
                      trackName,
                      trackLang
                    );
              ...
              function (reason) {
                ...
                console.log(
                  "Check your video on YouTube to be sure captions are available and published."
                );
                thisObj.hasCaptions = false;
                thisObj.usingYouTubeCaptions = false;
                deferred.resolve();
  ...
  AblePlayer.prototype.getYouTubeCaptionTracks2 = function (youTubeId) {
    ...
    $.ajax({
      ...
      error: function (xhr, status) {
        console.log(
          "Error retrieving YouTube caption data for video " + youTubeId
        );
        deferred.resolve();
      },
    });
  ...
  AblePlayer.prototype.getYouTubeTimedTextUrl = function (
    youTubeId,
    trackName,
    trackLang
  ) {
    ...
    if (options.length) {
      ...
      if (typeof this.ytCaptionModule !== "undefined") {
        if (this.usingYouTubeCaptions) {
          ...
          this.youTubePlayer.setOption(this.ytCaptionModule, "track", {
            languageCode: this.captionLang,
          });
...
(function ($) {
  ...
  window.AccessibleSlider = function (
    mediaType,
    div,
    orientation,
    length,
    ...
    this.seekHead.on(
      "mouseenter mouseleave mousemove mousedown mouseup focus blur touchstart touchmove touchend",
      function (e) {
        ...
        if (e.type === "mouseenter" || e.type === "focus") {
          ...
          thisObj.startTracking(
            "mouse",
            thisObj.pageXToPosition(
              thisObj.seekHead.offset() + thisObj.seekHead.width() / 2
            )
          );
  ...
  AccessibleSlider.prototype.arrowKeyDown = function (multiplier) {
    if (this.tracking && this.trackDevice === "keyboard") {
      this.keyTrackPosition = this.boundPos(
        this.keyTrackPosition + this.nextStep * multiplier
      );
      this.inertiaCount += 1;
      ...
      this.inertiaCount = 0;
      this.keyTrackPosition = this.boundPos(
        this.position + this.nextStep * multiplier
      );
...
*/
  ...
  AccessibleSlider.prototype.resizeDivs = function () {
    this.playedDiv.width(
      this.bodyDiv.width() * (this.position / this.duration)
    );
  ...
  AccessibleSlider.prototype.trackHeadAtPageX = function (pageX) {
    ...
    var newLeft =
      pageX - this.bodyDiv.offset().left - this.seekHead.width() / 2;
    newLeft = Math.max(
      0,
      Math.min(newLeft, this.bodyDiv.width() - this.seekHead.width())
    );
  ...
  AccessibleSlider.prototype.updateAriaValues = function (
    position,
    updateLive
  ) {
    ...
    if (pHours > 0) {
      ...
      descriptionText =
        pMinutes + " " + pMinuteWord + ", " + pSeconds + " " + pSecondWord;
    } else {
  ...
  AccessibleSlider.prototype.refreshTooltip = function () {
    if (this.overHead) {
      ...
      this.setTooltipPosition(
        this.seekHead.position().left + this.seekHead.width() / 2
      );
    } else if (this.overBody && this.overBodyMousePos) {
      this.timeTooltip.show();
      this.timeTooltip.text(
        this.positionToStr(this.pageXToPosition(this.overBodyMousePos.x))
      );
      this.setTooltipPosition(
        this.overBodyMousePos.x - this.bodyDiv.offset().left
      );
    } else {
      this.timeTooltip.hide();
    }
...
(function ($) {
  ...
  window.AccessibleDialog = function (
    modalDiv,
    $returnElement,
    dialogRole,
    title,
    ...
    modal.keydown(function (e) {
      ...
      // Tab
        ...
        var focusable = parts
          .filter(focusableElementsSelector)
          .filter(":visible");
...
(function ($) {
  AblePlayer.prototype.initDescription = function () {
    ...
    if (this.refreshingDesc) {
      ...
      if (typeof this.descFile !== "undefined") {
        ...
        if (this.youTubeDescId || this.vimeoDescId) {
          ...
          // there are no open-described versions from any source
      ...
      if (window.speechSynthesis) {
        ...
        for (var i = 0; i < this.descVoices.length; i++) {
          if (this.captionLang.length === 2) {
            ...
            if (
              this.descVoices[i].lang.substr(0, 2).toLowerCase() ===
              this.captionLang.toLowerCase()
            ) {
            ...
            if (
              this.descVoices[i].lang.toLowerCase() ===
              this.captionLang.toLowerCase()
            ) {
              this.descVoiceIndex = i;
              break;
    ...
    if (this.descOn) {
      ...
      // description is off.
      if (this.prevDescFormat === "video") {
        // user was previously using description via video
        if (this.usingAudioDescription()) {
          this.swapDescription();
        }
      } else if (this.prevDescFormat === "text") {
        // user was previously using text description
  ...
  AblePlayer.prototype.usingAudioDescription = function () {
    if (this.player === "youtube") {
      ...
      return (
        this.$sources.first().attr("data-desc-src") ===
        this.$sources.first().attr("src")
      );
    }
  };
      ...
      if (typeof this.youTubePlayer !== "undefined") {
        ...
        this.setupAltCaptions().then(function () {
          if (thisObj.playing) {
            ...
            thisObj.youTubePlayer.loadVideoById(
              thisObj.activeYouTubeId,
              thisObj.swapTime
            );
          } else {
  ...
  AblePlayer.prototype.showDescription = function (now) {
    ...
    if (typeof thisDescription !== "undefined") {
      if (this.currentDescription !== thisDescription) {
        ...
        descText = flattenComponentForDescription(
          cues[thisDescription].components
        );
        if (
...
(function ($) {
  ...
  AblePlayer.prototype.browserSupportsVolume = function () {
    ...
    userAgent = navigator.userAgent.toLowerCase();
    noVolume = /ipad|iphone|ipod|android|blackberry|windows ce|windows phone|webos|playbook/.exec(
      userAgent
    );
    if (noVolume) {
...
(function ($) {
  AblePlayer.prototype.seekTo = function (newTime) {
    ...
    if (this.player === "html5") {
      ...
      if (
        seekable.length > 0 &&
        this.startTime >= seekable.start(0) &&
        this.startTime <= seekable.end(0)
      ) {
  ...
  AblePlayer.prototype.getDuration = function () {
    ...
    if (this.player === "vimeo") {
      if (this.vimeoPlayer) {
        ...
        // vimeoPlayer hasn't been initialized yet.
        deferred.resolve(0);
      }
    } else {
      var duration;
      if (this.player === "html5") {
        ...
        if (this.youTubePlayer) {
          ...
          // the YouTube player hasn't initialized yet
          duration = 0;
        }
      }
      if (duration === undefined || isNaN(duration) || duration === -1) {
  ...
  AblePlayer.prototype.invokeHideControlsTimeout = function () {
    ...
    this.hideControlsTimeout = window.setTimeout(function () {
      if (
        typeof thisObj.playing !== "undefined" &&
        thisObj.playing === true &&
        thisObj.hideControls
      ) {
  ...
  AblePlayer.prototype.refreshControls = function (context, duration, elapsed) {
    ...
    if (context === "timeline" || context === "init") {
      ...
      if (this.seekBar) {
        if (this.useChapterTimes) {
          ...
          if (
            this.selectedChapters.cues[lastChapterIndex] == this.currentChapter
          ) {
            // this is the last chapter
            if (this.currentChapter.end !== this.duration) {
              // chapter ends before or after video ends
              // need to adjust seekbar duration to match video end
              this.seekBar.setDuration(
                this.duration - this.currentChapter.start
              );
            } else {
        ...
        if (!this.seekBar.tracking) {
          ...
          updateLive =
            this.liveUpdatePending ||
            this.seekBar.seekHead.is($(document.activeElement));
      ...
      if (typeof this.$durationContainer !== "undefined") {
        if (this.useChapterTimes) {
          this.$durationContainer.text(
            " / " + this.formatSecondsAsColonTime(this.chapterDuration)
          );
        } else {
          this.$durationContainer.text(
            " / " + this.formatSecondsAsColonTime(this.duration)
          );
        }
      }
      if (typeof this.$elapsedTimeContainer !== "undefined") {
        this.$elapsedTimeContainer.text(
          this.formatSecondsAsColonTime(displayElapsed)
        );
      }
      ...
      if (this.skin === "legacy") {
        ...
        if (this.seekBar) {
          widthUsed = 0;
          leftControls = this.seekBar.wrapperDiv
            .parent()
            .prev("div.able-left-controls");
      ...
      if (this.$descButton) {
        if (this.descOn) {
          this.$descButton
            ...
            .attr("aria-label", this.tt.turnOffDescriptions);
          this.$descButton
            .find("span.able-clipped")
            .text(this.tt.turnOffDescriptions);
        } else {
          this.$descButton
            .addClass("buttonOff")
            .attr("aria-label", this.tt.turnOnDescriptions);
          this.$descButton
            .find("span.able-clipped")
        ...
        if (!this.fullscreen) {
          ...
          if (this.iconType === "font") {
            this.$fullscreenButton
              .find("span")
              .first()
              .removeClass("icon-fullscreen-collapse")
              .addClass("icon-fullscreen-expand");
            this.$fullscreenButton
              .find("span.able-clipped")
              .text(this.tt.enterFullScreen);
          } else if (this.iconType === "svg") {
            ...
            this.$fullscreenButton
              .find("img")
              .attr("src", this.fullscreenExpandButtonImg);
          }
        } else {
          ...
          if (this.iconType === "font") {
            this.$fullscreenButton
              .find("span")
              .first()
              .removeClass("icon-fullscreen-expand")
              .addClass("icon-fullscreen-collapse");
            this.$fullscreenButton
              .find("span.able-clipped")
              .text(this.tt.exitFullScreen);
          } else if (this.iconType === "svg") {
            ...
            this.$fullscreenButton
              .find("img")
              .attr("src", this.fullscreenCollapseButtonImg);
          }
        }
      }
    }
    if (context === "playpause" || context == "init") {
      if (
        typeof this.$bigPlayButton !== "undefined" &&
        typeof this.seekBar !== "undefined"
      ) {
            ...
            if (!thisObj.seekBar.tracking && !thisObj.stoppingYouTube) {
              if (
                ...
                if (thisObj.iconType === "font") {
                  ...
                  thisObj.$playpauseButton
                    .find("img")
                    .attr("src", thisObj.playButtonImg);
                }
              } else {
                ...
                if (thisObj.iconType === "font") {
                  ...
                  thisObj.$playpauseButton
                    .find("img")
                    .attr("src", thisObj.pauseButtonImg);
                }
              }
            }
          });
  ...
  AblePlayer.prototype.changeRate = function (dir) {
    ...
    if (this.player === "html5") {
      ...
      if (index === -1) {
        console.log(
          "ERROR: Youtube returning unknown playback rate " +
    ...
    if (captions.length === 1) {
      ...
      if (this.captionsPopup && this.captionsPopup.is(":visible")) {
        ...
        if (this.captionsPopup) {
          ...
          this.captionsPopup.css(
            "top",
            this.$ccButton.position().top - this.captionsPopup.outerHeight()
          );
  ...
  AblePlayer.prototype.handleChapters = function () {
    ...
    if (this.chaptersPopup.is(":visible")) {
      ...
      this.chaptersPopup.css(
        "top",
        this.$chaptersButton.position().top - this.chaptersPopup.outerHeight()
      );
  ...
  AblePlayer.prototype.handlePrefsClick = function (pref) {
    ...
    if (this.prefsPopup.is(":visible")) {
      ...
      this.prefsPopup.css(
        "top",
        prefsButtonPosition.top - this.prefsPopup.outerHeight()
      );
  ...
  AblePlayer.prototype.handleTranscriptToggle = function () {
    ...
    if (this.$transcriptDiv.is(":visible")) {
      ...
      this.$transcriptButton
        .addClass("buttonOff")
        .attr("aria-label", this.tt.showTranscript);
      this.$transcriptButton
        .find("span.able-clipped")
        .text(this.tt.showTranscript);
  ...
  AblePlayer.prototype.handleSignToggle = function () {
    ...
    if (this.$signWindow.is(":visible")) {
      ...
      this.$signButton
        .addClass("buttonOff")
        .attr("aria-label", this.tt.showSign);
      ...
      this.$signButton
        .removeClass("buttonOff")
        .attr("aria-label", this.tt.hideSign);
  ...
  AblePlayer.prototype.setFullscreen = function (fullscreen) {
    ...
    if (this.nativeFullscreenSupported()) {
        ...
        function (e) {
          ...
          if (!thisObj.fullscreen) {
            ...
            thisObj.resizePlayer(
              thisObj.preFullScreenWidth,
              thisObj.preFullScreenHeight
            );
      ...
      if (fullscreen) {
        ...
        this.resizePlayer(
          this.$ableWrapper.width(),
          this.$ableWrapper.height()
        );
      }
  ...
  AblePlayer.prototype.retrieveOffscreenWindow = function (
    which,
    width,
    height
  ) {
  ...
  AblePlayer.prototype.getHighestZIndex = function () {
    ...
    $elements = $("body *").not(
      ".able-modal-dialog,.able-modal-dialog *,.able-modal-overlay,.able-modal-overlay *,.able-sign-window,.able-transcript-area"
    );

    $elements.each(function () {
      z = $(this).css("z-index");
      if (Number.isInteger(+z)) {
        // work only with integer values, not 'auto'
        if (parseInt(z) > max) {
          max = parseInt(z);
        }
      }
  ...
  AblePlayer.prototype.updateZIndex = function (which) {
    ...
    if (
      typeof this.$transcriptArea === "undefined" ||
      ...
      if (thisObj.usingYouTubeCaptions) {
        if (thisObj.captionsOn) {
          if (typeof thisObj.ytCaptionModule !== "undefined") {
            ...
            thisObj.youTubePlayer.setOption(thisObj.ytCaptionModule, "track", {
...
(function ($) {
  AblePlayer.prototype.populateChaptersDiv = function () {
    var headingLevel, headingType, headingId, $chaptersHeading, $chaptersList;
  ...
  AblePlayer.prototype.updateChaptersList = function () {
    ...
    if (typeof this.useChapterTimes === "undefined") {
      if (
        this.seekbarScope === "chapter" &&
        this.selectedChapters.cues.length
      ) {
...
(function ($) {
  ...
  AblePlayer.prototype.addTranscriptAreaEvents = function () {
    ...
    this.$transcriptDiv.on("mousewheel DOMMouseScroll click scroll", function (
      e
    ) {
  ...
  AblePlayer.prototype.setupManualTranscript = function () {
    ...
    this.$autoScrollTranscriptCheckbox = $(
      '<input id="autoscroll-transcript-checkbox" type="checkbox">'
    );
    this.$transcriptToolbar.append(
      $(
        '<label for="autoscroll-transcript-checkbox">' +
          this.tt.autoScroll +
          ": </label>"
      ),
      this.$autoScrollTranscriptCheckbox
  ...
  AblePlayer.prototype.showSearchResults = function () {
    ...
    if (this.searchDiv && this.searchString) {
      if ($("#" + this.SearchDiv)) {
        ...
        searchStringHtml +=
          '<span id="able-search-term-echo">' + this.searchString + "</span>";
        searchStringHtml += "</p>";
...
(function ($) {
  ...
  AblePlayer.prototype.onWindowResize = function () {
    if (this.fullscreen) {
      ...
      if (
        this.isUserAgent("Firefox") ||
        this.isUserAgent("Trident") ||
        this.isUserAgent("Edge")
      ) {
  ...
  AblePlayer.prototype.addSeekbarListeners = function () {
    ...
    this.seekBar.bodyDiv
      .on("startTracking", function (e) {
  ...
  AblePlayer.prototype.onPlayerKeyPress = function (e) {
    ...
    if (
      ...
      if (which === 27) {
        ...
        // Enter
        if (
          $thisElement.attr("role") === "button" ||
          $thisElement.prop("tagName") === "SPAN"
        ) {
          // register a click on this element
  ...
  AblePlayer.prototype.addHtml5MediaListeners = function () {
    ...
    this.$media
      ...
      .on("canplaythrough", function () {
        ...
        if (
          ...
          if (thisObj.startTime > 0) {
            ...
            thisObj.defaultChapter &&
            typeof thisObj.selectedChapters !== "undefined"
          ) {
          ...
          if (
            thisObj.playlistIndex !== thisObj.$playlist.length ||
            thisObj.loop
          ) {
      ...
      .on("volumechange", function () {
        ...
        if (thisObj.debug) {
          console.log(
            "media volume change to " +
              thisObj.volume +
              " (" +
              thisObj.volumeButton +
              ")"
          );
        }
      })
...
(function ($) {
  ...
  AblePlayer.prototype.addWindowMenu = function (which, $window, windowName) {
    ...
    $newButton.on("mouseenter focus", function (e) {
      ...
      var tooltip = AblePlayer.localGetElementById($newButton[0], tooltipId)
        .text(label)
        .css(tooltipStyle);
      thisObj.showTooltip(tooltip);
      $(this).on("mouseleave blur", function () {
    ...
    if (which === "transcript") {
      ...
      this.$transcriptToolbar.prepend(
        $windowAlert,
        $newButton,
        $tooltip,
        $popup
  ...
  AblePlayer.prototype.addResizeDialog = function (which, $window) {
    ...
    resizeDialog = new AccessibleDialog(
      ...
      $windowButton,
      "alert",
      this.tt.windowResizeHeading,
      $resizeWrapper,
      this.tt.closeButtonLabel,
      "20em"
    );
    if (which === "transcript") {
  ...
  AblePlayer.prototype.isCloseToCorner = function ($window, mouseX, mouseY) {
    ...
    right = left + width;
    if (
      Math.abs(bottom - mouseY) <= tolerance &&
      Math.abs(right - mouseX) <= tolerance
    ) {
      return true;
    }
    return false;
    ...
    if (this.player === "html5") {
      ...
      if (this.signFile) {
        if (this.isIOS()) {
          ...
          if (this.debug) {
            console.log(
              "Sign language has been disabled due to IOS restrictions"
            );
          }
        } else {
          if (this.debug) {
            console.log(
              "This video has an accompanying sign language video: " +
                this.signFile
            );
          }
      ...
      if (lang) {
        if (lang !== this.lang) {
          if ($.inArray(lang, this.getSupportedLangs()) !== -1) {
            ...
            msg =
              lang +
              " is not currently supported. Using default language (" +
              this.lang +
              ")";
            if (this.debug) {
              console.log(msg);
...
(function ($) {
  AblePlayer.prototype.injectVTS = function () {
    ...
    if ($("#able-vts").length) {
      ...
      if (this.vtsTracks.length) {
        ...
        $p1 = $("<p>").text(
          "Use the Video Transcript Sorter to perform any of the following tasks:"
        );
        $ul = $("<ul>");
        $li1 = $("<li>").text(
          "Reorder chapters, descriptions, captions, and/or subtitles so they appear in the proper sequence in Able Player's auto-generated transcript."
        );
        $li2 = $("<li>").text(
          "Modify content or start/end times (all are directly editable within the table)."
        );
        $li3 = $("<li>").text(
          "Insert new content, such as chapters or descriptions."
        );
        $p2 = $("<p>").text(
          'When finished editing, click the "Save Changes" button. This will auto-generate new content for all relevant timed text files (chapters, descriptions, captions, and/or subtitles), which can be copied and pasted into separate WebVTT files for use by Able Player.'
        );
        ...
        for (i in this.langs) {
          ...
          $radio = $("<input>", {
            ...
            thisObj.showVtsAlert(
              "Loading " + thisObj.getLanguageName(thisObj.vtsLang) + " tracks"
            );
        ...
        $("#able-vts-save").on("click", function (e) {
          ...
          if ($(this).attr("value") == "save") {
            ...
            thisObj.showVtsAlert(
              "Cancelling saving. Any edits you made have been restored in the VTS table."
            ); // TODO: Localize this
          }
        });
      }
  ...
  AblePlayer.prototype.setupVtsTracks = function (
    kind,
    lang,
    label,
    src,
  ...
  AblePlayer.prototype.getFilenameFromTracks = function (kind, lang) {
    for (var i = 0; i < this.vtsTracks.length; i++) {
      if (
        this.vtsTracks[i].kind === kind &&
        this.vtsTracks[i].language === lang
      ) {
  ...
  AblePlayer.prototype.parseVtsTracks = function (contents) {
    ...
    while (i < rows.length) {
      ...
      if (thisRow.indexOf(" --> ") !== -1) {
        ...
        if (
          this.isValidTimestamp(timeParts[0]) &&
          this.isValidTimestamp(timeParts[2])
        ) {
    ...
    for (i = 0; i < buttons.length; i++) {
      ...
      if (button === "up") {
        if (rowNum > 1) {
          ...
          pathString =
            "M249.628,176.101L138.421,52.88c-6.198-6.929-16.241-6.929-22.407,0l-0.381,0.636L4.648,176.101" +
        ...
        if (rowNum < numRows) {
          ...
          pathString =
            "M286.935,69.377c-3.614-3.617-7.898-5.424-12.848-5.424H18.274c-4.952,0-9.233,1.807-12.85,5.424" +
        ...
        pathString =
          "M394,154.175c-5.331-5.33-11.806-7.994-19.417-7.994H255.811V27.406c0-7.611-2.666-14.084-7.994-19.414" +
        ...
        pathString =
          "M397.281,31.782h-63.565C333.716,14.239,319.478,0,301.934,0h-95.347" +
        ...
        pathString2 =
          "M79.456,476.737c0,17.544,14.239,31.782,31.782,31.782h286.042" +
  ...
  AblePlayer.prototype.updateVtsActionButtons = function (
    $buttons,
    nextRowNum
  ) {
  ...
  AblePlayer.prototype.adjustTimes = function (rowNum) {
    ...
    minDuration = [];
    minDuration["captions"] = 0.001;
    minDuration["descriptions"] = 0.001;
    minDuration["chapters"] = 0.001;
    ...
    if (rowNum > 1) {
      ...
      prevStart = this.getSecondsFromColonTime(
        $prevRow.find("td").eq(2).text()
      );
    ...
    if (rowNum < $rows.length - 1) {
      ...
      nextStart = this.getSecondsFromColonTime(
        $nextRow.find("td").eq(2).text()
      );
    ...
    if (isNaN(start)) {
      ...
      if (prevKind === "captions") {
        ...
        start = (parseFloat(prevEnd) + 0.001).toFixed(3);
        if (nextStart) {
          // end the new row immediately before the next row starts
          end = (parseFloat(nextStart) - 0.001).toFixed(3);
        } else {
        ...
        start = (parseFloat(prevStart) + 0.001).toFixed(3);
        if (nextStart) {
          // end the new row immediately before the next row starts
          end = (parseFloat(nextStart) - 0.001).toFixed(3);
        } else {
        ...
        start = (parseFloat(prevStart) + minDuration["descriptions"]).toFixed(
          3
        );
      ...
      if (prevStart) {
        ...
        if (prevStart < start) {
          if (start < nextStart) {
            ...
            nextEnd = (parseFloat(nextStart) + minDuration[nextKind]).toFixed(
              3
            );
    ...
    if (end - start < minDuration[kind]) {
      ...
      if (nextStart) {
        ...
        nextStart = (parseFloat(end) + 0.001).toFixed(3);
      }
    }
    ...
    if ($prevRow) {
      $prevRow
        .find("td")
        .eq(2)
        .text(this.formatSecondsAsColonTime(prevStart, true));
      $prevRow
        .find("td")
        .eq(3)
        .text(this.formatSecondsAsColonTime(prevEnd, true));
    }
    if ($nextRow) {
      $nextRow
        .find("td")
        .eq(2)
        .text(this.formatSecondsAsColonTime(nextStart, true));
      $nextRow
        .find("td")
        .eq(3)
        .text(this.formatSecondsAsColonTime(nextEnd, true));
    }
  };
  ...
  AblePlayer.prototype.showWebVttOutput = function (kind, vttString, lang) {
    ...
    if (filename) {
      pText +=
        "to replace the original content of your " +
        this.getLanguageName(lang) +
        " ";
      pText +=
        "<em>" +
        kind +
        "</em> WebVTT file (<strong>" +
        filename +
        "</strong>).";
    } else {
      pText +=
...
(function ($) {
  AblePlayer.prototype.initVimeoPlayer = function () {
    ...
    this.vimeoPlayer.ready().then(function () {
      if (!thisObj.hasPlaylist) {
        ...
        thisObj.vimeoPlayer
          .setPlaybackRate(thisObj.vimeoPlaybackRate)
  ...
  AblePlayer.prototype.resizeVimeoPlayer = function (
    youTubeId,
    youTubeContainerId
  ) {
