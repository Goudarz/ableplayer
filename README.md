...
To play a Vimeo video in _Able Player_, simply include a **data-vimeo-id** attribute
...
The source JavaScript files for Able Player are in the _/scripts_ directory,
